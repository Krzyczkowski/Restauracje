...
public class GeneralWindowSet {
    ...
    protected void setActualWindow(Scene actual){
        ...
        actual.setOnMousePressed(mouseEvent -> {
            xCordinates = mouseEvent.getSceneX();
            yCordinates = mouseEvent.getSceneY();
        });

        actual.setOnMouseDragged(mouseEvent -> {
    ...
    protected void setEmployesScene() throws IOException {
        ...
        employesScene.getStylesheets().add(Objects.requireNonNull(getClass().getResource("style.css")).toExternalForm());
    ...
    protected void  setProductsScene() throws IOException {
        ...
        productsScene.getStylesheets().add(Objects.requireNonNull(getClass().getResource("style.css")).toExternalForm());
    ...
    protected void setWarehouseScene() throws IOException {
        ...
        warehouseScene.getStylesheets().add(Objects.requireNonNull(getClass().getResource("style.css")).toExternalForm());
    ...
    protected void setHistoryScene() throws IOException {
        ...
        historyScene.getStylesheets().add(Objects.requireNonNull(getClass().getResource("style.css")).toExternalForm());
    ...
    protected void setOrderScene() throws IOException {
        ...
        orderScene.getStylesheets().add(Objects.requireNonNull(getClass().getResource("style.css")).toExternalForm());
